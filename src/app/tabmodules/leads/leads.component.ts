...
import { LeadDeleteSelectionComponent } from '../../componentmodules/leads/dialogboxes/delete.selection.dialog.component';
...
@Component({
	...
	styleUrls: [
		'../../componentmodules/leads/css/leadtable.component.css',
		'./leads.component.css'
	],
...
export class LeadDatabaseComponent implements OnInit, AfterViewInit {
